	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('Idpacientes,NmPaciente,DtNascimento,Sexo,Cpf,Rg,Profissao,NmPai,NmMae,NrCarteira,EndRua,EndBairro,EndCidade,EndCep,EndUf,NrTelefone,NrCelular,CtEmail,Senha,Usuario,CdConvenio,CdLaudo,CdProntuario,Idade'
				, '%'.$filter.'%')
			);
