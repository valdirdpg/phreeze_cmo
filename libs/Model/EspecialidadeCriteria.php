...
require_once("DAO/EspecialidadeCriteriaDAO.php");

/**
 * The EspecialidadeCriteria class extends EspecialidadeDAOCriteria and is used
 ...
 * @version 1.0
 */
class EspecialidadeCriteria extends EspecialidadeCriteriaDAO
{
