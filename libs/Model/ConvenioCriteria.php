...
require_once("DAO/ConvenioCriteriaDAO.php");

/**
 * The ConvenioCriteria class extends ConvenioDAOCriteria and is used
 ...
 * @version 1.0
 */
class ConvenioCriteria extends ConvenioCriteriaDAO
{
