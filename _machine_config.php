<?php
/**
 * @package CLÍNICA MÉDICA E ODONTOLÓGICA - CMO
 *
...
GlobalConfig::$CONNECTION_SETTING->DBName = "clinicacmo";
...
/** the root url of the application with trailing slash, for example http://localhost/clínica médica e odontológica - cmo/ */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'clinicacmo/';
